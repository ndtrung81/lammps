...
#define MAX_CONTACTS 32 // maximum number of contacts for 3D models
...
{
  int mode,ifirst,iefirst,itype,npi1,npi2;
  ...
  itype = static_cast<int>(edge[iefirst+edge_index][0]);
  npi1 = static_cast<int>(edge[iefirst+edge_index][1]);
  npi2 = static_cast<int>(edge[iefirst+edge_index][2]);
